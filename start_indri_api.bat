@echo off
REM TTS Playground API Starter - Indri Model
...
echo ============================================================
echo TTS Playground API - Indri Model
echo ============================================================
echo.
echo Project Directory: %SCRIPT_DIR%
echo Virtual Environment: venv-indri
echo Model: indri
echo.

REM Check if virtual environment exists
if not exist "%SCRIPT_DIR%\venv-indri\Scripts\activate.bat" (
    echo ERROR: Virtual environment not found at %SCRIPT_DIR%\venv-indri
    echo Please create it first by running: python -m venv venv-indri
    echo.
    pause
    exit /b 1
)
...
"%SCRIPT_DIR%\venv-indri\Scripts\python.exe" "%SCRIPT_DIR%\api\start_api.py"
